...
import MeetingModal from "@/components/block/Modal/MeetingModal";
        ...
        <section className="flex flex-col items-center justify-center py-10 min-[481px]:py-16 bg-transparent p-4 min-[481px]:p-6">
          <div className="text-white text-center max-w-3xl mx-auto">
            ...
            <button
              ...
              className="mt-4 min-[481px]:mt-6 px-6 min-[481px]:px-8 py-2 min-[481px]:py-3 text-base min-[481px]:text-lg bg-gradient-to-r from-blue-500 to-blue-700 text-white font-semibold rounded-full shadow-lg hover:scale-105 transform transition duration-300"
            >
              BOOK NOW
            </button>
          </div>
