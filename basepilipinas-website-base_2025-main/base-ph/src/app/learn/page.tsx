...
export default function LearnPage() {
  return (
    <div className="min-h-screen bg-transparent">
      <main className="w-full">
        <div className="max-w-[1536px] mx-auto py-4 sm:py-6 md:py-8 px-4 sm:px-6 xl:px-8">
          ...
          <section className="mb-12 sm:mb-14 md:mb-16">
            <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-center">Learning Resources</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
              ...
              <div className="flex flex-col h-full rounded-xl overflow-hidden bg-transparent border border-white/10 hover:border-white/20 transition-all">
                ...
                <div className="p-4 sm:p-6 flex flex-col flex-grow bg-white/5 backdrop-blur-sm">
                  <h3 className="text-xl sm:text-2xl font-semibold mb-2 sm:mb-3">Documentation</h3>
      ...
      {/* Featured Content */}
          <section className="mb-12 sm:mb-14 md:mb-16">
            <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-center">Featured Content</h2>
              ...
              <div className="rounded-xl overflow-hidden bg-[#0A192F] border border-white/10 hover:border-white/20 transition-all">
                ...
                >
                  <div className="p-4 sm:p-6">
                    <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">Introduction to Base</h3>
          ...
          {/* Community Section */}
          <section className="mb-12 sm:mb-14 md:mb-16">
            <div className="flex flex-col items-center justify-center py-8 sm:py-12 border-t border-white/10 max-w-3xl mx-auto">
