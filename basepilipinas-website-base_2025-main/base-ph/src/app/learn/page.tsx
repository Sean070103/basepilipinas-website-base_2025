            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-5 lg:gap-6 max-w-4xl mx-auto px-4">
              ...
              <div className="flex flex-col rounded-lg overflow-hidden bg-[#0A192F]/80 border border-white/10 hover:border-white/20 transition-all">
                ...
                <div className="p-3 sm:p-4 flex flex-col flex-grow">
                  ...
                  <div className="mb-3">
                    <h4 className="text-xs sm:text-sm md:text-base font-medium mb-1.5">Getting Started:</h4>
                    <ul className="text-xs sm:text-sm md:text-base text-white/70 space-y-1">
                      ...
                      <li className="flex items-start space-x-2">
                        <span className="text-white/70 mt-1">•</span>
                        <span className="flex-1">Setting up your environment</span>
                      </li>
                      <li className="flex items-start space-x-2">
                        <span className="text-white/70 mt-1">•</span>
              ...
              <div className="flex flex-col rounded-lg overflow-hidden bg-[#0A192F]/80 border border-white/10 hover:border-white/20 transition-all">
                ...
                <div className="p-3 sm:p-4 flex flex-col flex-grow">
                  ...
                  <div className="mb-3">
                    <h4 className="text-xs sm:text-sm md:text-base font-medium mb-1.5">Featured Content:</h4>
                    <ul className="text-xs sm:text-sm md:text-base text-white/70 space-y-1">
                      <li className="flex items-start space-x-2">
                        <span className="text-white/70 mt-1">•</span>
                        <span className="flex-1">Smart Contract Development Exercises</span>
                      </li>
                      <li className="flex items-start space-x-2">
                        <span className="text-white/70 mt-1">•</span>
                        <span className="flex-1">Frontend Development for Onchain Apps</span>
                      </li>
                    </ul>
              </div>
                <Link
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 md:gap-5 lg:gap-6 mb-4 sm:mb-6 md:mb-8 max-w-4xl mx-auto px-4">
              ...
              <div className="rounded-lg overflow-hidden bg-[#0A192F]/80 border border-white/10 hover:border-white/20 transition-all">
                ...
                <div className="p-3 sm:p-4">
                  ...
                  <div className="mb-3">
                    <h4 className="text-xs sm:text-sm md:text-base font-semibold mb-1.5">What You&apos;ll Learn:</h4>
                    <ul className="text-xs sm:text-sm md:text-base text-white/70 space-y-1">
              ...
              <div className="rounded-lg overflow-hidden bg-[#0A192F]/80 border border-white/10 hover:border-white/20 transition-all">
                ...
                <div className="p-3 sm:p-4">
                  ...
                  <div className="mb-3">
                    <h4 className="text-xs sm:text-sm md:text-base font-semibold mb-1.5">Program Highlights:</h4>
                    <ul className="text-xs sm:text-sm md:text-base text-white/70 space-y-1">
                      <li className="flex items-start space-x-2">
                        <span className="text-white/70 mt-1">•</span>
          ...
          <section className="mb-8 sm:mb-10 md:mb-12 lg:mb-14">
            ...
            <Link
              ...
              rel="noopener noreferrer"
                ...
                >
                  <svg className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-4.5 md:w-4.5 lg:h-5 lg:w-5" viewBox="0 0 24 24" fill="currentColor">
