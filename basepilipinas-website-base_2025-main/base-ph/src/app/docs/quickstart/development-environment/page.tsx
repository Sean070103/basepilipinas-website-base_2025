...
export default function DevelopmentEnvironmentPage() {
  return (
    <div className="container space-y-8 max-sm:max-w-[330px]">
        ...
        <div className="space-y-6">
          <div className="bg-white/5 rounded-lg p-6">
            ...
            <div className="mt-4 bg-black/30 rounded p-4">
              <code className="text-sm">npm install -g @base/cli</code>
            </div>
          </div>
      ...
      <section className="container">
        ...
        <div className="space-y-6">
          <div className="bg-white/5 rounded-lg p-6">
            ...
            <div className="mt-4 bg-black/30 rounded p-4 w-full overflow-auto">
              <p className="text-sm text-white/80 whitespace-nowrap block min-w-max">
