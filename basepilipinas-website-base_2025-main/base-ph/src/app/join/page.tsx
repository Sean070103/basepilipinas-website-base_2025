...
export default function JoinPage() {
  return (
    <>
      ...
      {/* Hero Section */}
        <section className="relative w-full flex items-center justify-center p-4 sm:p-6 py-20 sm:py-28 overflow-hidden">
      ...
      {/* Benefits Section */}
        <section className="py-16 px-4 sm:px-6 overflow-hidden">
          <div className="max-w-[1040px] mx-auto overflow-hidden">
          <h2 className="text-2xl sm:text-3xl font-bold text-white text-center mb-12">
            Why Join Us?
          </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 overflow-hidden">
              ...
              />
                ...
                <div>
                  ...
                  <p className="text-white/90 text-sm">
                      Access exclusive resources, workshops, and mentorship opportunities to accelerate your Web3 journey.
                  </p>
                </div>
              </div>
            </div>
              ...
              />
                ...
                <div>
                  ...
                  <p className="text-white/90 text-sm">
                      Connect with like-minded individuals and build valuable relationships in the Web3 space.
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* CTA Section */}
        <section className="py-16 px-4 sm:px-6 overflow-hidden">
          <div className="max-w-[1040px] mx-auto text-center overflow-hidden">
